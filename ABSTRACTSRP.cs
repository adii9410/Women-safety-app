...
// Abstract Class: Admin "Login"
abstract class Login
{
    public abstract void Admin();
}

    // Abstract Override class: Admin login
class admin_login : Login
{
    ...
    // Abstract Class: "Transaction": Trans
    // Child of Security class
    abstract class Trans : security
    {
        public abstract void withdraw();
        public abstract void deposit();
    }

    // Abstract Override class: Transaction
    ...
    // Abstract Override class: account
    ...
    // Abstract Override delete class
    // Admin Function
    class delete : Delete
    {
    ...
    // Security class
    // Parent for "User_login", "Trans", "Register", "User_update" Class
