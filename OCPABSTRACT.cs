...
abstract class aACCOUNTS {

    public abstract void User_Update();
    public abstract void User_detail();
    public abstract void User_register();
} 

sealed class User_account : aACCOUNTS
{
    public override void User_detail()
    {
        for (int i = 0; i < PD.accnum.Count; i++)
        {
            if (PD.ACCID == PD.accnum[i])
    ...
    public override void User_register() { }
    public override void User_Update() { }
}

class Register : aACCOUNTS//
{
    public override void User_register()
    {
...
abstract class aOnline: iTransaction
{
    public abstract void withdraw();
    public abstract void deposit();
}

abstract class imode: iTransaction
{
...
abstract class iAdminControl
{
    public abstract void Admin_delete();
    public abstract void Admin_detail();
    public abstract void Admin_table_detail();
}

sealed class Admin_account : iAdminControl
{
    public override void Admin_detail()
    {
    ...
    public override void Admin_table_detail()
    {
    ...
    public override void Admin_delete() { }
}
