...
// Interface Class: Admin "Login"
interface Login
{
    void Admin();
}

// Interface Override class: Admin login
...
// Interface Class: "Transaction": Trans
// Child of Security class
interface Trans
{
...
// Interface Override class: Transaction
class Transaction : Security, Trans
{
    public void withdraw()
    {
        PD.check = 2;
...
// Interface Override class: account
...
// Interface Override delete class
// Admin Function
class delete : Delete
{
