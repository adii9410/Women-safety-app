...
{
    void Admin();
    void SetNext(iLogin next);
}
class admin_login : iLogin
{
    private iLogin _next;
    public void SetNext(iLogin next)
    {
        _next = next;
    }
    public void Admin()
...
class Ulogin : iLogin
{
    ...
    public void Admin()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                Console.WriteLine("Client Login Sucessful");
                PD.check = 1;
                break;
            }
            else if (_next != null)
...
abstract class Trans : Security_MPIN
{
    public abstract void withdraw();
    public abstract void deposit();
}
sealed class Transaction : Trans
{
...
class Program
{
    static void Main(string[] args)
    {
        ...
        PD pD = new PD();
        var adminLogin = new admin_login();
        var userLogin = new Ulogin();
        User_login user_Login = new User_login();
        Transaction transWithdraw = new Transaction();
        ...
        var client = new Client(adminLogin);
