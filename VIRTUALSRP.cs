...
// Virtual Class: account
// Virtual Method for User "Detail"
...
// Virtual Method for Admin to display "User Detail"
public class AdminDtail: account
{
...
// Child of Security class
// Virtual Method for User Register
...
// Virtual Override Function
// Virtual Method for user detail "update"
public class User_update : Register
{
...
// Security class
// Parent for "User_login", "Transaction", "Register" Class
...
class Program
{
    static void Main(string[] args)
    {
        ...
        AdminDtail adminDtail = new AdminDtail();
